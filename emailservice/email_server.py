...
class EmailService(BaseEmailService):
    ...
    @staticmethod
    def send_email(client, email_address, content):  # noqa: F821
        response = client.send_message(  # noqa: F841
            sender=client.sender_path(
                "", "", ""
            ),  # TODO: configure project_id, region, sender_id
            envelope_from_authority="",
            header_from_authority="",
            envelope_from_address="",  # TODO: configure from_address
            simple_message={
                "from": {
                    "address_spec": "",  # TODO: configure from_address
                },
